...
本计划于 2026-08-28 确认，是 N0–N6 与 W0–W6 全部完成后的下一条独立主线。S0–S3 已完成；S4–S5 尚未开始实现。每个阶段必须在上一阶段完成专项、前序与全量回归并单独提交后才能开始。
...
状态：已完成（2026-08-29）。实现与验收见 [S3 实施记录](S3_LEGACY_SAFE_RETIREMENT.md)。S4 尚未开始。
