...
6. [S_PRODUCTION_HARDENING_AND_RETRIEVAL_PLAN.md](S_PRODUCTION_HARDENING_AND_RETRIEVAL_PLAN.md)：W6 之后的 S0–S5 生产化与检索升级计划；S0–S3 已完成，S4–S5 尚未开始。
...
LLM Wiki + Obsidian 主线的 W0–W6 与生产化 S0–S3 已完成；S4–S5 尚未开始，具体边界见 [S 系列实施计划](S_PRODUCTION_HARDENING_AND_RETRIEVAL_PLAN.md)。
