...
print()
print("=" * 60)
print("Langfuse 追踪配置（可选）")
print("=" * 60)
print(check("LANGFUSE_TRACING", optional=True))
print(check("LANGFUSE_PUBLIC_KEY", optional=True))
print(check("LANGFUSE_SECRET_KEY", optional=True))
print(check("LANGFUSE_BASE_URL", optional=True))
