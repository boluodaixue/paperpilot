    ...
    *,
    ...
    async def think_and_plan(
        ...
        with _node_trace("think_and_plan", state) as observation:
            ...
            fork_calls = [call for call in calls if call["function"].get("name") == FORK_TOOL_NAME]
            if fork_calls:
    ...
    def synthesize(
        ...
        with _node_trace("synthesize", state) as observation:
            ...
            incomplete_children = [
                child for child in state["child_results"] if child.status != ResearchStatus.COMPLETED
            ]
            ...
            result = ResearchResult(
                ...
                child_result_refs=tuple(child.task_id for child in state["child_results"]),
                stop_reason=stop_reason,
